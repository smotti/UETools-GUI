...
struct BP_Smoke_C_ExecuteUbergraph_BP_Smoke final
{
public:
	...
	double                                        CallFunc_Conv_DoubleToVector_InDouble_ImplicitCast; // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Conv_DoubleToVector_InDouble_ImplicitCast_1; // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
