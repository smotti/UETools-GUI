...
struct GCN_Fire_GunHead_SHG05_C_OnBurst final
{
public:
	...
	class ABP_Gunhead_Head_ROOT_C*                K2Node_DynamicCast_AsBP_Gunhead_Head_ROOT;         // 0x0138(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
