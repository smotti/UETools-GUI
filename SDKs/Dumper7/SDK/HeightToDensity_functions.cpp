...
#include "HeightToDensity_classes.hpp"
#include "HeightToDensity_parameters.hpp"
...
void UHeightToDensity_C::ExecuteWithContext(struct FPCGContext& InContext, const struct FPCGDataCollection& Input, struct FPCGDataCollection* Output)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HeightToDensity_C", "ExecuteWithContext");

	Params::HeightToDensity_C_ExecuteWithContext Parms{};
...
bool UHeightToDensity_C::PointLoopBody(const struct FPCGContext& InContext, const class UPCGPointData* InData, const struct FPCGPoint& InPoint, struct FPCGPoint* OutPoint, class UPCGMetadata* OutMetadata, int64 Iteration) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HeightToDensity_C", "PointLoopBody");

	Params::HeightToDensity_C_PointLoopBody Parms{};
