...
struct GCN_Fire_Vehicle_Machinegun_C_OnBurst final
{
public:
	...
	class ABP_VehicleWeaponBase_C*                K2Node_DynamicCast_AsBP_Vehicle_Weapon_Base;       // 0x0138(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
