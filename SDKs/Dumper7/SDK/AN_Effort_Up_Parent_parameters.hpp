...
struct AN_Effort_Up_Parent_C_Received_Notify final
{
public:
	...
	class UBP_AC_PlayerSprint_SFX_C*              CallFunc_GetComponentByClass_ReturnValue;          // 0x0060(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
