...
struct GCN_Fire_SHG03_AI_C_OnBurst final
{
public:
	...
	class ABP_ShotgunWeaponBase_C*                K2Node_DynamicCast_AsBP_Shotgun_Weapon_Base;       // 0x0138(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
