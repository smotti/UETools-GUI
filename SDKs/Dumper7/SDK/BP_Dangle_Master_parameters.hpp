...
struct BP_Dangle_Master_C_Check_Mantle_Fix final
{
public:
...
struct BP_Dangle_Master_C_ExecuteUbergraph_BP_Dangle_Master final
{
public:
...
struct BP_Dangle_Master_C_IgnorePlayers final
{
public:
	...
	TArray<class UStaticMeshComponent*>           CallFunc_K2_GetComponentsByClass_ReturnValue_1;    // 0x0030(0x0010)(ReferenceParm, ContainsInstancedReference)
...
// 0x0040 (0x0040 - 0x0000)
struct BP_Dangle_Master_C_MantleFix final
{
public:
