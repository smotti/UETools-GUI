...
struct GCN_Fire_Turret_C_OnBurst final
{
public:
	...
	class USoundBase*                             SB_Turret_MS;                                      // 0x0138(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ABP_WeaponBase_C*                       K2Node_DynamicCast_AsBP_Weapon_Base;               // 0x0140(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
