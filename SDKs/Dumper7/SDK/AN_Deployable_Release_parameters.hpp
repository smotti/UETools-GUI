...
struct AN_Deployable_Release_C_Received_Notify final
{
public:
	...
	bool                                          CallFunc_SendGameplayEventToActor_ReturnValue;     // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
