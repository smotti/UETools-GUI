...
// Function AN_Effort_Down_Parent.AN_Effort_Down_Parent_C.Received_Notify
// 0x0098 (0x0098 - 0x0000)
struct AN_Effort_Down_Parent_C_Received_Notify final
{
public:
	...
	class UBP_AC_PlayerSprint_SFX_C*              CallFunc_GetComponentByClass_ReturnValue;          // 0x0080(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SpawnSoundAttached_VolumeMultiplier_ImplicitCast; // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
