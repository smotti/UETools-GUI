...
struct AN_Player_VictimSyncKill_C_Received_Notify final
{
public:
	...
	class ABP_MusicManager_Dynamic_Parent_C*      CallFunc_GetActorOfClass_ReturnValue;              // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_AC_HealthSFX_C*                     CallFunc_GetComponentByClass_ReturnValue;          // 0x0078(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
