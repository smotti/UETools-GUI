...
2. Generate a Dumper-7 SDK for the target title. Pre-compiled Dumper-7 can be found in Releases, consider reading through ["How to use"](https://github.com/Encryqed/Dumper-7/blob/main/README.md).
